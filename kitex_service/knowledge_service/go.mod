module github.com/Airiseina/answer/kitex_service/knowledge_service
...
require (
	...
	github.com/volcengine/volcengine-go-sdk v1.2.32 // indirect
...
replace github.com/Airiseina/answer/pkg => ../../pkg
